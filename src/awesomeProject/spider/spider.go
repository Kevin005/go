...
/**
爬虫
https://blog.csdn.net/superwebmaster/article/details/80319502
https://blog.csdn.net/superwebmaster/article/details/80324442
 */
import (
	"fmt"
	"io"
...
func main() {
	if checkFile("/home/kevin/", "url.txt").Size() == 0 {
		fistStart()
		main()
	} else {
		Timer()
...
func Timer() {
	...
	<-t.C
	fmt.Print("\n\n\n执行爬抓\n\n")
	f, _ := os.OpenFile("/home/kevin/url.txt", os.O_CREATE|os.O_APPEND|os.O_RDWR, 0666)
	...
	DelFirstText("/home/kevin/url.txt")
	Timer()
}
...
func fistStart() {
	...
	for _, d := range reg.FindAllString(string(body), -1) {
		ff, _ := os.OpenFile("/home/kevin/url.txt", os.O_RDWR, 0666)
